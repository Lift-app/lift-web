  ...
  <div class="page--category-posts">
    ...
    <header class="header" :class="normalizedCategory(category.name)">
      ...
      <div class="category-posts-details">
        ...
        <button @click="toggleInterest" aria-label="Categorie toevoegen aan interesses" :class="category.is_interested ? 'liked like-button' : 'like-button'">
          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
           viewBox="0 0 190 195" xml:space="preserve" class="thumb-icon">
    ...
    <div v-if="loading">
      ...
      <div class="card-group" v-if="!loading">
        <card v-for="post in posts" :key="post.id" :post="post" component-name="Post"></card>
